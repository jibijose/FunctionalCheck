...
public class App {
  ...
  private void invokeObjectOrientedClassWay() {
    ...
    System.out.println("Compare string1 and string2 Using HashCode and Equals: "
        + Arrays.equals(string1, string2));
    System.out.println("Compare string1 and string2 Using DeepHashCode and DeepEquals: "
        + Arrays.deepEquals(string1, string2));

    // Marking two arrays as null
    num1 = null;
    num2 = null;
    /* Same Behavior when arrays are null */
    System.out.println("Compare (null arrays) num1 and num2 Using HashCode and Equals: "
        + Arrays.equals(num1, num2));
    System.out.println("Compare (null arrays) num1 and num2 Using DeepHashCode and DeepEquals: "
        + Arrays.deepEquals(num1, num2));

    /* With nested objects, Behavior is totally different */
    System.out.println("third".hashCode());
    System.out.println("third".hashCode());
    System.out.println(new String[] {"third"}.hashCode());
    System.out.println(new String[] {"third"}.hashCode());

    System.out.println("third".equals("third"));
    System.out.println(new String[] {"third"}.equals("third"));

    System.out.println("Compare object1 and object2 Using HashCode and Equals: "
        + Arrays.equals(object1, object2));
